<template>
  <div class="home-container">
    ...
    <div class="riskAreaEntry-container">
      <div class="content">
        <div class="left">高风险地区 <span class="high">2</span> 个 中风险地区 <span class="mid">55</span> 个</div>
...
onMounted(async () => {
  const data = await getCovInfo();
  console.log(data);
  newsList.value = data.newslist[0].news;  // 疫情热点
});
